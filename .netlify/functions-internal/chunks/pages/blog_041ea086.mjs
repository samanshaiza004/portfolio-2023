...
const $$PostCard = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="mt-6"><img class="my-2 shadow-md drop-shadow-sm" src="src/images/project1.jpg" alt="blog" width="300px"><p>Hello!</p></div>`;
