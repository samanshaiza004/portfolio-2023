...
const $$Nav = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Nav;
  return renderTemplate`${maybeRenderHead()}<header class="lg:flex p-5 gap-5">${renderComponent($$result, "Astronav", $$Astronav, {}, { "default": ($$result2) => renderTemplate`<div class="flex w-full justify-between"><a class="opacity-70 hover:opacity-100 transition duration-100" href="mailto: samanshaiza@yahoo.com">samanshaiza@yahoo.com</a><div class="block lg:hidden">${renderComponent($$result2, "MenuIcon", $$MenuIcon, { "class": "w-4 h-4 text-white" })}</div></div>${renderComponent($$result2, "MenuItems", $$MenuItems, { "class": "hidden lg:flex" }, { "default": ($$result3) => renderTemplate`<ul class="flex flex-col lg:flex-row lg:gap-5"><li><a class="opacity-70 hover:opacity-100 transition duration-100" href="/">home</a></li><li><a class="opacity-70 hover:opacity-100 transition duration-100" href="/blog">blog</a></li><li><a class="opacity-70 hover:opacity-100 transition duration-100" href="/projects">projects</a></li><li><a class="opacity-70 hover:opacity-100 transition duration-100" href="">music</a></li></ul>` })}` })}</header>`;
